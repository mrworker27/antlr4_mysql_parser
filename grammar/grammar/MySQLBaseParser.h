#ifndef __BASEPARSER__
#define __BASEPARSER__
...
class MySQLBaseParser : public Parser
{
public:
    MySQLBaseParser(TokenStream *input) : Parser(input) {}
...
public:
    MySQLBaseLexer(CharStream *input) {}
    void emitDot() {}
    bool isSqlModeActive(int MOO)
    {
        return false; // some logic here from ts
